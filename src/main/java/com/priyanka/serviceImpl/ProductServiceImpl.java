...
public class ProductServiceImpl implements ProductService {
	...
	public Product saveProduct(Product product) {
		...
		if(product.getProductType()	==	null || product.getProductDescription()	==	null||product.getProductDescription().isEmpty()||
				...
				product.getProductExpiry() <=0|| product.getProductLimit() <= 0 ||
				product.getProductPayment() <=0 || product.getProductPayment() >31)	{
			throw new IllegalArgumentException("All fields are mandatory to find a product");
		}
